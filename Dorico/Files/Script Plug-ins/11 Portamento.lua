...
app:doCommand([[UI.InvokePropertyChangeValue?Type=kGlissandoLineText&Value=string: "kPort"]])
app:doCommand([[UI.InvokePropertyChangeValue?Type=kGlissandoLineTextBehaviour&Value=string: "kAlwaysShow"]])
app:doCommand([[UI.InvokePropertyChangeValue?Type=kGlissandoPlaybackType&Value=string: "kNone"]])
